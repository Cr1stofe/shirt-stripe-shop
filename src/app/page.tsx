  ...
  return (
    <div className="flex flex-col md:grid grid-cols-2 gap-12 w-full max-w-[1376px] my-0 mx-auto min-h-[656px] p-4">
      ...
      {products.map(product => {
        return (
          <div key={product.id} className="bg-gradient-to-b from-gradient-top to-gradient-bottom rounded-lg cursor-pointer relative overflow-hidden flex items-start justify-center group">
